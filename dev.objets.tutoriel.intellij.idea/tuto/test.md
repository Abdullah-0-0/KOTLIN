...
Placez vous dans `Calcul.kt` et selectionnez une des deux fonctions implémentées. Selectionnez `Code > Generate... > Test...
`
![](img/junit.png)
...
> Par défaut, l'assistant de création de cas de test, créé une fonction de test par méthode à tester. C'est souvent bien insufisant.

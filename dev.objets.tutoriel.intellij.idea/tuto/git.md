...
> *Dans la ressource "Gestion de projet" (responsable JM Mottu)  vous aborderez/avez abordé en détail l'usage d'un gestionnaire de version Git.*


__Attention__ il est nécessaire que le projet sur le dépôt Git soit bien un projet IntelliJ/gradle correct.

...
class TestCarteBonusPlusCompareTo {
    @ParameterizedTest
    @MethodSource("donneCartes")
    fun testCarte2ndeChanceCompareTo(otherCarte: Carte, expected: Int){
        val carteBonusPlus = CarteBonusPlus(6)

        assertEquals(carteBonusPlus.compareTo(otherCarte),expected)
    }

...
class ControleurFreezeBtn(vue: VueFlip7, modele: ModeleFlip7): EventHandler<ActionEvent>  {
    ...
    override fun handle(event: ActionEvent?) {
        ...
        if (modele.carteAction != null) {
            modele.flip7.joueurCourantCibleStop(modele.carteAction!!, modele.mainJoueur)
